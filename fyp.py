...
def load_data():
    covid=pd.read_csv("D:\kdu\Final Year Project\Dataset\COVIDdata.csv")
    latest=covid[covid["Date"] == "2021-03-13"][["Country","Population","Confirmed","Deaths","Recovered","Active"]]
    confirmed_df = pd.read_csv("D:/kdu/Final Year Project/Datasets/Confirmed_data.csv")
    death_df = pd.read_csv("D:/kdu/Final Year Project/Datasets/Deaths_data.csv")
    recovered_df = pd.read_csv("D:/kdu/Final Year Project/Datasets/Recovered_data.csv")
